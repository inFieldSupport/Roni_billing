...
RSpec.describe 'Standards', type: :request do
  describe 'standard controller' do
    it 'PUT' do
      employee = Employee.new(name: 'Roni', email: 'example@gmail.com', password: 'password',
                              password_confirmation: 'password')
      employee.save
      client = Client.new(name: 'Roni', company_name: 'Any', email: 'example@gmail.com', address: 'Any')
      client.save
      standard = Standard.new(client_id: client.id, standard_rate: 32, standard_type: 'Telematics', active_users: 32,month:"January",year:2023)
      standard.save

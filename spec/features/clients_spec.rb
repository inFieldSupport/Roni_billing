...
RSpec.describe 'Client', type: :feature do
    before :each do
       @employee = Employee.create(name:"ANy",email:"roni@gmail.com",password:"foobar",password_confirmation:"foobar" )
    ...
    scenario 'view clients' do
        @user = User.create(id:1,client_id:@client.id,user_rate:32,user_type:"Admin",active_users:32)
        @standard = Standard.create(client_id:@client.id,standard_rate:32,standard_type:"Telematics",active_users:32)
        visit root_path

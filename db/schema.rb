...
ActiveRecord::Schema[7.0].define(version: 2023_02_24_131114) do
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.index ["user_type", "month", "year", "client_id"], name: "index_users_on_user_type_and_month_and_year_and_client_id", unique: true
  end
